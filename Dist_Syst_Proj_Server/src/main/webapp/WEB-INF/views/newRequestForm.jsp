...
<style>
	...
	input[type=submit]{background-color: #4CAF50;cursor:pointer;border-radius:5px;text-align:center;font-size:20px}
...
<body>
	...
	<h2>Fill the following fields and submit request:</h2>
	<div class="requestFormData">
		<form:form method="POST" modelAttribute="req" action="/dist_syst_proj/saveNewRequest">
			...
			Rate: <form:select path="rate" required="true">
						<form:option value="" label="---Select Rate---"/>
						<form:option value="12%">12%</form:option>
						<form:option value="18%">18%</form:option>
				  </form:select><br><br>
			Customer's ID: <form:input path="customerId" required="true"/><br><br>
	...
	<div class="calculator">
		...
		<button style="font-size:20px;" id="calcButton" class="btn btn-success" onclick="myFoo()">Calculate!</button>
	</div>
	${message}
	<a href="/dist_syst_proj/employeePage" style="font-size:20px;" class="btn btn-success" role="button">Return to Search Page!</a>
</body>
</html>